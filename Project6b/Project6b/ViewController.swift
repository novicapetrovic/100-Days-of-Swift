...
//  Project6b
//
//  Created by Novica Petrovic on 03/03/2020.
...
//            label.widthAnchor.constraint(equalTo: view.widthAnchor).isActive = true
            ...
            label.heightAnchor.constraint(lessThanOrEqualTo: view.safeAreaLayoutGuide.heightAnchor, multiplier: 0.2).isActive = true
